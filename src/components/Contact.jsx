...
import { Mail, Phone, MapPin, Github, Linkedin, Code, Send, MessageSquare, User, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Let's connect and discuss opportunities in AI/ML, software development, or research collaboration. 
            I'm always excited to work on innovative projects and learn from fellow developers.
          </p>
        </div>
